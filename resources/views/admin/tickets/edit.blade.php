<x-app-layout>
    ...
    <div class=" mt-5">
        <a href="{{ route('admin.tickets.index') }}" class="text-white bg-gray-500 py-1 px-5 text-lg m-10 rounded dark:bg-gray-400 dark:text-gray-700">Back</a>
...
<form action="{{ route('admin.tickets.update', $ticket->id) }}" method="POST" class="max-w-md mx-auto mt-10">
@csrf
@method('PUT')
<div class="mb-6">
