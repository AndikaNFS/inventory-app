<x-app-layout>
    ...
    @endif
    <div class=" mt-5">
    <a href="{{ route('admin.tickets.index') }}" class="text-black py-1 px-5 text-lg m-10 rounded bg-gray-400">Back</a>
    ...
    <form action="{{ route('admin.tickets.store') }}" method="POST" enctype="multipart/form-data" class="max-w-md mx-auto mt-10">
        @csrf
